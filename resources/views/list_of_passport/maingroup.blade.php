...
<div class="wrapper mt-5 px-5">
    <form action="{{ url('listpassport/maingroup/simpan/' . $datakegiatan->id) }}" method="POST">
        @csrf
        @method('POST')
        @if ($errors->any())
        ...
        <div class="d-flex justify-content-evenly jadwal-dinas">
            <div class="mt-3">
                ...
                <select id="select-state" class="form-select mb-3" aria-label="Default select example"
                    name="passport_id" id="passport_id" placeholder="Cari Personil">
            ...
            <input type="hidden" name="tim_kegiatan" id="tim_kegiatan" value="group" class="form-control"
    ...
    <div class="container" style="margin-top: -100px;">
        <div class="card shadow">
            <div class="table-responsive" style="padding: 20px;">
                <h4 class="text-center">DATA MAIN GROUP</h4>
                <form action="{{ url('listpassport/maingroup/export/' . $datakegiatan->id) }}" method="GET"
                    class="d-flex">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <button type="submit" class="btn btn-success mb-3 mr-3" name="pdf" value="pdf" role="button">
                    ...
                    <input type="hidden" name="jenis_kegiatan" id="jenis_kegiatan" value="group">
                ...
                <table id="example" class="table table-responsive nowrap" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $nomor }}</td>
                            <td>
                                <img class="mb-2" src="{{ asset('storage/' . $dp['foto_pegawai']) }}" alt="foto"
                            ...
                            <td>
                                ...
                                <label for="">-</label>
                                @else
                                <img class="mb-2" src="{{ asset('storage/' .$dp['scan_visa']) }}" alt="foto"
                                    height="120px" width="200px">
                                @endif
                            </td>
                            <td>
                                @if ($dp['scan_exitpermit'] != "null")
                                <img class="mb-2" src="{{ asset('storage/' . $dp['scan_exitpermit']) }}" alt="foto"
                                    height="120px" width="200px">
                                @else
                                <label for="">-</label>
                                @endif
                            ...
                            <td>
                                ...
                                <img class="mb-2" src="{{ asset('storage/' . $dp['scan_vaksin']) }}" alt="foto"
                                    height="120px" width="200px">
                                @else
                                <label for="">-</label>
                                @endif
